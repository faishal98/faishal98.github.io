...
bool validateLogin(const std::string& username, const std::string& password) {
    return (username == "Faishal" && password == "Deanna");
}
...
int main() {
    ...
    while (true) {
        std::cout << "apakah kamu spesial menurut ku?" << std::endl;
        ...
        if (jawaban == "yes") {
            ...
            std::cout << "Aaaa,Aku Sayang kamu><" << std::endl;
            break;
        } else if (jawaban == "no") {
            std::cout << "Aaaaaa, Kenapa no, Harus yes 😠" << std::endl;
            std::this_thread::sleep_for(std::chrono::seconds(2));
            continue;
        } else {
